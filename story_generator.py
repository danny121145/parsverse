...
# --- Load .env from repo folder (robust for OneDrive paths) ---
BASE_DIR = os.path.dirname(__file__)
load_dotenv(dotenv_path=os.path.join(BASE_DIR, ".env"))

# --- Streamlit Secrets -> os.environ (for Streamlit Cloud) ---
try:
...
# Expanded forbidden Indic / non-Iranian set
BANNED_MAP = {
    ...
    r"\bveda(s)?\b": "",
    r"\bvedic\b": "",
    r"\batman\b": "",      # avoid collision with 'Atman'
    r"\bātman\b": "",
    r"\bbrahma(n)?\b": "",
    r"\bbrahmin\b": "",
    r"\bindra\b": "",
...
# Transliteration: prefer Iranian endonyms over Greek/Latin exonyms
